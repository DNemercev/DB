...
<form action="{{ route('user.login') }}" method="POST">
    ...
    <div class="form-group">
        <button class="btn btn-lg btn-privary" type="submit" name="sendMe" value="1">Войти</button>
    </div>
</form>

<form action="{{route('user.registration')}}" method="GET">
    <button type="submith" class="btn">Регистрация</button>
</form>
</body>
</html>
